...
class MainScreenModel extends ChangeNotifier {
  ...
  // List<NewsRequest> get newsNews => _news.toList();
   ...
   // news.sort((a,b)=> a.lastModified!.compareTo(b.lastModified!));
  //
  ...
  Future<void> updateNewsRequests() async {
    ...
    news.sort((a,b)=> b.lastModified!.compareTo(a.lastModified!));
    _news += news;
    notifyListeners();
  }

  Future<void> onNewsItemTap(BuildContext context, int index) async {
    // final id = _news[index].id;
